...
<div ID="sakumlapa">
    ...
    <form id="forma1" title="Ievadiet tikai burtus">
        <input type="text" onkeydown="return alphaOnly(event);" name="vardaLauks" id="vards"
               placeholder="Ievadiet savu vardu">
    </form>
    <br> <!--  brīva rinda -->
    <div style="text-align: center">
        ...
        <select id="izvele">
            ...
            // raksta uz ekrāna kamēr ir ko rakstīt - cik dažādu testu ir
